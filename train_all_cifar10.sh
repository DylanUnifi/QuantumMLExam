...
echo "=============================="
python main.py --model classical_mlp --config configs/config_train_classical_cifar10.yaml | tee logs_cifar10/classical_mlp.log
...
echo "=============================="
python main.py --model hybrid_qcnn --config configs/config_train_hybrid_qcnn_cifar10.yaml | tee logs_cifar10/hybrid_qcnn.log
